...
- 출력 데이터 항목 (Output Data):
  ...
  - 제어 버튼: 로그인 버튼, 간편 구글 소셜 로그인 버튼, 회원가입 전환 링크, 
...
### 1.2.2.3 메인 피드 목록 화면(카테고리 눌렀을 시) (`/`)
...
### 1.2.5 마이페이지 화면 (`/profile`, `/membership`)
